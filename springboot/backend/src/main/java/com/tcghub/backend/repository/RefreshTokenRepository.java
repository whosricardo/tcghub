...
public class RefreshTokenRepository {
    ...
    private final RowMapper<RefreshToken> refreshTokenMapper = (rs, rowNum) -> new RefreshToken(
            rs.getLong("id"),
            rs.getString("token"),
            rs.getString("email"),
    ...
    public RefreshToken save(RefreshToken refreshToken) {
        String sql = "INSERT INTO refresh_tokens (token, email, expiry, revoked) VALUES (?, ?, ?, ?)";
    ...
    public Optional<RefreshToken> findByToken(String token) {
        ...
        return jdbcTemplate.query(sql, refreshTokenMapper, token).stream().findFirst();
    }
